...
<div align="center">
<img src="https://skillicons.dev/icons?i=html,css,tailwind,sass,nodejs,react,nextjs,svelte,vue,flutter,flask,ts,js,cs,rust,python,dart,php,solidity,mongodb,mysql,threejs,figma,unity,godot,linux,git,aws,nginx,docker,kubernetes,jenkins,cypress,jest" alt="known-language"/>
</div> 
